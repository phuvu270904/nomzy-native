...
export default function HomeScreen() {
  ...
  const renderDiscountRestaurant = ({
    item,
  }: {
    item: (typeof discountRestaurants)[0];
  }) => (
  ...
  const renderRecommendedItem = ({
    ...
    item: (typeof recommendedItems)[0];
  }) => (
    <TouchableOpacity style={styles.recommendedItem} activeOpacity={0.7}>
      ...
      <View style={styles.recommendedInfo}>
        ...
        <ThemedText style={styles.recommendedRestaurant}>
          {item.restaurant}
        </ThemedText>
        <View style={styles.recommendedDetails}>
          <View style={styles.ratingContainer}>
            <Ionicons name="star" size={12} color="#FFD700" />
            <ThemedText style={styles.recommendedRating}>
              {item.rating}
            </ThemedText>
          </View>
