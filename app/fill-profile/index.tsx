...
export default function FillProfileScreen() {
  ...
  const handleContinue = () => {
    ...
    // Store data temporarily and navigate to location screen
    router.push({
      pathname: "/fill-profile/set-location",
      params: {
        avatarUri: avatar,
        gender: gender,
      },
              ...
              >
                ...
                >
                  <Ionicons
                    name="male"
                    size={32}
                    color={gender === "male" ? "#FFFFFF" : "#4CAF50"}
                  />
                </View>
                <ThemedText
                  style={[
              ...
              >
                ...
                >
                  <Ionicons
                    name="female"
                    size={32}
                    color={gender === "female" ? "#FFFFFF" : "#4CAF50"}
                  />
                </View>
                <ThemedText
                  style={[
