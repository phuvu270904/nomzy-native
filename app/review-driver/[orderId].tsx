...
export default function ReviewDriverScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await reviewsApi.submitDriverReview(driverInfo.id, {
        rating,
        review: review.trim(),
        isAnonymous,
      });

      // Navigate to restaurant feedback screen
      router.replace({
        pathname: "/review-restaurant/[orderId]",
        params: { orderId },
      });
    } catch (error) {
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            <ThemedText style={styles.headerTitle}>Rate Your Driver</ThemedText>
